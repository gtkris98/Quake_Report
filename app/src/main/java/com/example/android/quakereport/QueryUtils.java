...
public final class QueryUtils
{
    ...
    public static ArrayList<EarthquakeData> extractEarthquakes() {
        ...
        try {
            ...
            {
                JSONObject earthquake = earthquakeArray.getJSONObject(i).getJSONObject("properties");
                Double magnitude = earthquake.getDouble("mag");
                String place = earthquake.getString("place");
                Long time = Long.parseLong(earthquake.getString("time"));
                String url = earthquake.getString("url");
                earthquakes.add(new EarthquakeData(place,magnitude,time,url));
            }
